    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        ...
        <form:form action="savemat" method="post" modelAttribute="listematieres">
            <table border="1" >
                <tr>
                    <td>ID: </td>
                    <td>${listematieres.id_Matiere}
                        <form:hidden path="id_Matiere"/>
                    </td>
                </tr>        
            <tr>
                    <td>Name: </td>
                ...
                <tr>
                    <td colspan="2"><input type="submit" value="savemat"></td>
                </tr>                    
            </table>
        </form:form>
    </div>
